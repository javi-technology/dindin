...
// ---------------------------------------------------------------------------
// Testes de contrato dos tipos compartilhados (issue #7)
// Valida que os tipos exportados possuem os campos obrigatórios esperados
...
describe('shared-types – Position', () => {
...
describe('shared-types – FridgeItem', () => {
